...
- 2026-05-03–04 — self-contained `index.html` prototype built covering all three pages: Home, Recipe, and Cooking Mode. All core design decisions locked through iterative mobile review. Non-goals for this next.js phase remain: no database, no auth, no build step required. Prototype opens directly in Safari.
