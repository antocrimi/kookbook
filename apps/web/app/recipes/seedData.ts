...
const CRISPY_GNOCCHI: SeedRecipe = {
  ...
  source: "NYT Cooking",
  description:
    "Skip the boil — shelf-stable gnocchi pan-fry straight from the package into golden, crisp-edged pillows. Add cherry tomatoes and a few cloves of garlic to the same pan and let them collapse into a chunky sauce; finish off the heat with torn fresh mozzarella so it just melts.",
  default_servings: 4,
  time_min: 20,
  original_photo_path:
  ...
  ingredients: [
    ...
    {
      raw: "1 (1-pound) package shelf-stable potato gnocchi",
      item: "shelf-stable potato gnocchi",
      quantity: { value: 1, unit: "lb" },
    },
    { raw: "Salt and black pepper", item: "salt and black pepper" },
    {
      raw: "2 pints cherry or grape tomatoes",
      item: "cherry or grape tomatoes",
      quantity: { value: 2, unit: "pint" },
    },
    {
      raw: "4 garlic cloves, thinly sliced",
    ...
    {
      raw: "8 ounces fresh mozzarella, torn into bite-size pieces",
      item: "fresh mozzarella, torn into bite-size pieces",
      quantity: { value: 8, unit: "oz" },
    },
    {
      raw: "½ cup fresh basil leaves, torn",
...
const ZUCCHINI_PANCAKES: SeedRecipe = {
  slug: "zucchini-pancakes",
  title: "Zucchini Pancakes",
  source: "NYT Cooking",
  description:
    "Crisp on the outside, tender inside, generously herbed — these pancakes turn an end-of-summer surplus of zucchini into something dinner-worthy. Salting and squeezing the grated zucchini is the only step that takes patience; everything else comes together in one bowl.",
  default_servings: 4,
  time_min: 30,
  original_photo_path:
  ...
  ingredients: [
    {
      ...
      quantity: { value: 2, unit: "whole" },
      note: "medium, about 1 lb total",
    },
    {
      raw: "1 teaspoon kosher salt, plus more to taste",
      item: "kosher salt",
      quantity: { value: 1, unit: "tsp" },
      note: "plus more to taste",
    },
    {
      raw: "2 large eggs, lightly beaten",
      item: "eggs, lightly beaten",
      quantity: { value: 2, unit: "whole" },
      note: "large",
    },
    {
      raw: "3 scallions, thinly sliced",
      item: "scallions, thinly sliced",
      quantity: { value: 3, unit: "whole" },
    },
    {
      raw: "½ cup all-purpose flour",
      item: "all-purpose flour",
      quantity: { value: 0.5, unit: "cup" },
    },
    {
      raw: "¼ cup grated Parmesan",
      item: "grated Parmesan",
      quantity: { value: 0.25, unit: "cup" },
    },
    {
      raw: "2 tablespoons chopped fresh dill",
      item: "fresh dill, chopped",
      quantity: { value: 2, unit: "tbsp" },
    },
    {
      raw: "¼ teaspoon black pepper",
      item: "black pepper",
      quantity: { value: 0.25, unit: "tsp" },
    },
    {
      raw: "4 tablespoons olive oil, divided",
      item: "olive oil",
      quantity: { value: 4, unit: "tbsp" },
      note: "divided",
    },
    {
      raw: "Sour cream or plain yogurt, for serving",
...
const RHUBARB_MACAROON_TART: SeedRecipe = {
  slug: "rhubarb-macaroon-tart",
  title: "Rhubarb Macaroon Tart",
  source: "NYT Cooking",
  description:
    "A buttery shortbread crust holds tart spring rhubarb under a chewy coconut-and-almond macaroon top. The contrast — crisp pastry, jammy fruit, lacy meringue-coconut crown — is what carries the whole thing.",
  default_servings: 8,
  time_min: 20,
  original_photo_path:
  ...
  ingredients: [
    {
      ...
      item: "all-purpose flour",
      quantity: { value: 1.25, unit: "cup" },
      note: "plus more for rolling",
      group: "Pastry",
    },
    {
    ...
    {
      raw: "8 tablespoons cold unsalted butter, cubed",
      item: "cold unsalted butter, cubed",
      quantity: { value: 8, unit: "tbsp" },
      group: "Pastry",
    },
    {
      raw: "1 large egg yolk",
      item: "egg yolk",
      quantity: { value: 1, unit: "whole" },
      note: "large",
      group: "Pastry",
    ...
    {
      raw: "2 to 3 tablespoons ice water",
      item: "ice water",
      range: { low: 2, high: 3, unit: "tbsp" },
      group: "Pastry",
    },
    {
      raw: "1 pound fresh rhubarb, cut into 1-inch pieces",
      item: "fresh rhubarb, cut into 1-inch pieces",
      quantity: { value: 1, unit: "lb" },
      group: "Filling",
    },
    {
      raw: "¾ cup granulated sugar",
      item: "granulated sugar",
      quantity: { value: 0.75, unit: "cup" },
      group: "Filling",
    },
    {
      raw: "1 tablespoon lemon juice",
      item: "lemon juice",
      quantity: { value: 1, unit: "tbsp" },
      group: "Filling",
    },
    ...
    {
      raw: "2 large egg whites",
      item: "egg whites",
      quantity: { value: 2, unit: "whole" },
      note: "large",
      group: "Macaroon topping",
    },
    {
      raw: "¼ teaspoon salt",
      item: "salt",
    ...
    {
      raw: "1½ cups sweetened shredded coconut",
      item: "sweetened shredded coconut",
      quantity: { value: 1.5, unit: "cup" },
      group: "Macaroon topping",
    },
    {
      raw: "½ cup sliced almonds",
      item: "sliced almonds",
      quantity: { value: 0.5, unit: "cup" },
      group: "Macaroon topping",
    },
  ...
  steps: [
    {
      text: "In a food processor, pulse the flour, sugar and salt to combine. Add the butter and pulse until coarse crumbs form. Add the egg yolk and 2 tablespoons ice water; pulse until the dough just comes together, adding more water if needed. Form into a disk, wrap and chill at least 30 minutes.",
      group: "Pastry",
    },
    {
      text: "Heat the oven to 375°F. Roll the dough on a lightly floured surface into an 11-inch round and press into a 9-inch tart pan with a removable bottom; trim excess. Prick the bottom with a fork. Line with parchment, fill with pie weights and bake 15 minutes. Remove parchment and weights and bake 5 minutes more. Let cool slightly.",
      group: "Pastry",
    },
    {
      text: "In a bowl, toss the rhubarb with the sugar, lemon juice and vanilla. Spread evenly in the cooled crust.",
      group: "Filling",
    },
    {
      text: "In a clean bowl, beat the egg whites and salt until soft peaks form. Fold in the coconut and almonds. Spoon evenly over the rhubarb.",
      group: "Macaroon topping",
    },
    {
      text: "Bake until the topping is golden and the rhubarb is bubbling, 35 to 40 minutes. Cool completely on a rack before slicing.",
      group: "Macaroon topping",
    },
  ],
};

const SHEET_PAN_FETA: SeedRecipe = {
  slug: "sheet-pan-feta",
  title: "Sheet-Pan Feta With Chickpeas and Tomatoes",
  source: "NYT Cooking",
  description:
    "A whole block of feta nestled into a sheet pan of chickpeas and cherry tomatoes, then roasted until the tomatoes burst and the cheese turns soft and golden at the edges. Mash everything together at the table and scoop with bread.",
  default_servings: 4,
  time_min: 40,
  original_photo_path:
  ...
  ingredients: [
    ...
    {
      raw: "1 small red onion, thinly sliced",
    ...
    {
      raw: "4 garlic cloves, smashed",
      item: "garlic, smashed",
      quantity: { value: 4, unit: "clove" },
    },
    {
      raw: "1 teaspoon dried oregano",
      item: "dried oregano",
      quantity: { value: 1, unit: "tsp" },
    },
    {
    ...
    { raw: "Salt and black pepper", item: "salt and black pepper" },
    {
      raw: "8 ounces block feta, drained",
      item: "block feta, drained",
      quantity: { value: 8, unit: "oz" },
    },
    {
      raw: "½ cup fresh parsley, dill or mint, torn",
      item: "fresh herbs (parsley, dill or mint), torn",
      quantity: { value: 0.5, unit: "cup" },
    },
    {
      raw: "1 lemon, cut into wedges",
      item: "lemon, cut into wedges",
      quantity: { value: 1, unit: "whole" },
    },
    {
      raw: "Crusty bread or pita, for serving",
      item: "crusty bread or pita",
      note: "for serving",
    },
  ],
  steps: [
...
const LEMON_BUTTER_SALMON: SeedRecipe = {
  slug: "lemon-butter-salmon",
  title: "Lemon Butter Salmon With Dill",
  source: "NYT Cooking",
  description:
    "A weeknight pan-seared salmon with crackly skin and a fast garlic-lemon butter spooned over the top. The whole thing comes together in one skillet in under twenty minutes — fancy enough for company, simple enough for a Tuesday.",
  default_servings: 4,
  time_min: 20,
  original_photo_path:
  ...
  ingredients: [
    ...
    {
      raw: "1 tablespoon olive oil",
      item: "olive oil",
      quantity: { value: 1, unit: "tbsp" },
    },
    {
      raw: "4 tablespoons unsalted butter",
    ...
    {
      raw: "1 lemon, half juiced and half cut into wedges",
      item: "lemon, half juiced and half cut into wedges",
      quantity: { value: 1, unit: "whole" },
    },
    {
      raw: "¼ cup chopped fresh dill, plus more for serving",
      item: "fresh dill, chopped",
      quantity: { value: 0.25, unit: "cup" },
      note: "plus more for serving",
    },
...
const SPICED_PEA_STEW: SeedRecipe = {
  slug: "spiced-pea-stew",
  title: "Spiced Pea Stew With Yogurt",
  source: "NYT Cooking",
  description:
    "Frozen peas, a deep base of warm spices and a generous swirl of yogurt — this is the kind of stew that feels both quick and considered. Serve over basmati or scoop with flatbread; the yogurt cools, the lemon brightens, the peas keep their squeaky pop.",
  default_servings: 4,
  time_min: 20,
  original_photo_path:
  ...
  ingredients: [
    ...
    {
      raw: "1 large yellow onion, finely chopped",
    ...
    {
      raw: "1 (1-inch) piece fresh ginger, grated",
      item: "fresh ginger, grated",
      quantity: { value: 1, unit: "inch" },
    },
    {
      raw: "1 jalapeño, seeded and minced",
      item: "jalapeño, seeded and minced",
      quantity: { value: 1, unit: "whole" },
    },
    {
      raw: "1 tablespoon ground cumin",
      item: "ground cumin",
      quantity: { value: 1, unit: "tbsp" },
    },
    {
      raw: "1 tablespoon ground coriander",
      item: "ground coriander",
      quantity: { value: 1, unit: "tbsp" },
    },
    {
      raw: "1 teaspoon ground turmeric",
      item: "ground turmeric",
      quantity: { value: 1, unit: "tsp" },
    },
    {
      raw: "½ teaspoon ground cinnamon",
      item: "ground cinnamon",
      quantity: { value: 0.5, unit: "tsp" },
    },
    {
      raw: "1 (14-ounce) can crushed tomatoes",
      item: "crushed tomatoes",
      quantity: { value: 1, unit: "whole" },
      note: "14-ounce can",
    },
    {
      raw: "1½ cups vegetable broth",
      item: "vegetable broth",
      quantity: { value: 1.5, unit: "cup" },
    },
    {
      raw: "4 cups frozen peas",
      item: "frozen peas",
      quantity: { value: 4, unit: "cup" },
    },
    {
      raw: "½ cup full-fat plain yogurt, plus more for serving",
      item: "full-fat plain yogurt",
      quantity: { value: 0.5, unit: "cup" },
      note: "plus more for serving",
    },
    {
    ...
    { raw: "Salt and black pepper", item: "salt and black pepper" },
    {
      raw: "Cooked basmati rice or warm flatbread, for serving",
      item: "cooked basmati rice or warm flatbread",
      note: "for serving",
    },
  ],
  steps: [
